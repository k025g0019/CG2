...
//================================================================
// TrailLinkBlock - GameObject へ追加する C++ Component
//================================================================

class TrailLinkBlock final : public EditorNativeScript {
public:
	TrailLinkBlock();  // 公開変数と Input Action 関数を登録する。
...
private:
	...
	std::string startMessage_ = "TrailLinkBlock::Start";  // Inspector から編集する開始ログ。
