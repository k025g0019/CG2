...
//================================================================
// TrailLinkEnemy - GameObject へ追加する C++ Component
//================================================================

class TrailLinkEnemy final : public EditorNativeScript {
public:
	TrailLinkEnemy();  // 公開変数と Input Action 関数を登録する。
...
private:
	...
	std::string startMessage_ = "TrailLinkEnemy::Start";  // Inspector から編集する開始ログ。
