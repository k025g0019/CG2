...
//================================================================
// TrailLinkPlayer - GameObject へ追加する C++ Component
//================================================================

class TrailLinkPlayer final : public EditorNativeScript {
public:
	TrailLinkPlayer();  // 公開変数と Input Action 関数を登録する。
...
private:
	...
	std::string startMessage_ = "TrailLinkPlayer::Start";  // Inspector から編集する開始ログ。
