	...
	while (message.message != WM_QUIT) {
		if (PeekMessage(&message, nullptr, 0, 0, PM_REMOVE) != FALSE) {
			...
			*wvpData = worldViewProjectionMatrix;
			...
			// RootSignature繧定ｨｭ螳壹１SO縺ｫ險ｭ螳壹＠縺ｦ縺・ｋ縺代←蛻･騾碑ｨｭ螳壹′蠢・ｦ・
