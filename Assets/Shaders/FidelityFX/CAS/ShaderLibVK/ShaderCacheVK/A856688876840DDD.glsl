...
#define ID_4PS_LASTID 3
#define ID_4PS_NORMAL 2
#define ID_4PS_POSITION 0
#define ID_4PS_TANGENT 3
#define ID_4PS_TEXCOORD_0 1
#define ID_4VS_NORMAL 0
#define ID_4VS_POSITION 1
#define ID_4VS_TANGENT 2
#define ID_4VS_TEXCOORD_0 3
#define ID_PER_FRAME 0
#define ID_PER_OBJECT 1
#define ID_baseColorTexture 4
#define ID_baseTexCoord 0
#define ID_brdfTexture 0
#define ID_diffuseCube 1
#define ID_emissiveTexCoord 0
#define ID_emissiveTexture 5
#define ID_metallicRoughnessTextCoord 0
#define ID_metallicRoughnessTexture 6
#define ID_normalTexCoord 0
#define ID_normalTexture 7
#define ID_occlusionTexCoord 0
#define ID_occlusionTexture 8
