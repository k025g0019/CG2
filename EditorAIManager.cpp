...
#include "externals/AI/MicroPather-master/micropather.h"
#include "externals/AI/cppGOAP-develop/src/Planner.h"
#pragma warning(pop)
...
void EditorAIManager::Start() {
	...
	isStarted_ = true;
	PushConsoleMessage("AI: externals/AI の AI Component を開始しました。");
}
