...
OceanSpectrumResult EvaluatePreparedOceanSpectrumAtTime(
    float2 basePosition,
    ...
    float oceanElapsedTime)
{
    ...
    oceanResult.time = oceanElapsedTime * gTransformationMatrix.oceanParams3.z;
...
{
    return EvaluatePreparedOceanSpectrumAtTime(
        basePosition,
