...
//================================================================
// TrailLinkOutZone - GameObject へ追加する C++ Component
//================================================================

class TrailLinkOutZone final : public EditorNativeScript {
public:
	TrailLinkOutZone();  // 公開変数と Input Action 関数を登録する。
...
private:
	...
	std::string startMessage_ = "TrailLinkOutZone::Start";  // Inspector から編集する開始ログ。
