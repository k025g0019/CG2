// このファイルは Engine が自動生成します。ユーザーコードは TrailLinkOutZone.cpp へ記述してください。
...
namespace {
	...
	struct ScriptInstance {
		...
		TrailLinkOutZone script;
	};

	TrailLinkOutZone& GetMetadataState() {
		static TrailLinkOutZone metadataState;
