// このファイルは Engine が自動生成します。ユーザーコードは TrailLinkPlayer.cpp へ記述してください。
...
namespace {
	...
	struct ScriptInstance {
		...
		TrailLinkPlayer script;
	};

	TrailLinkPlayer& GetMetadataState() {
		static TrailLinkPlayer metadataState;
