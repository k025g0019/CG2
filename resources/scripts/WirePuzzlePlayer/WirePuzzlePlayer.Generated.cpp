// このファイルは Engine が自動生成します。ユーザーコードは WirePuzzlePlayer.cpp へ記述してください。
...
namespace {
	...
	struct ScriptInstance {
		...
		WirePuzzlePlayer script;
	};

	WirePuzzlePlayer& GetMetadataState() {
		static WirePuzzlePlayer metadataState;
